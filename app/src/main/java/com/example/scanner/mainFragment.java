...
//            }
//        });
////        // Définissez un OnClickListener pour l'image
...
////
////                // Influez le menu déroulant avec un fichier de menu
////                popupMenu.getMenuInflater().inflate(R.menu.popup_menu, popupMenu.getMenu());
////
////                // Définissez un OnMenuItemClickListener pour le PopupMenu
////                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
////                    @Override
////                    public boolean onMenuItemClick(MenuItem item) {
////                        // Switch sur l'ID de l'élément cliqué
